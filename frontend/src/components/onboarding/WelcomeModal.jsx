          ...
          <div className="w-full relative min-h-[200px] flex flex-col items-center justify-center">
            {step === 1 && (
              <div className="animate-fade-in flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Step 1: Dump Your Raw Footage</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-[280px]">
                  Stop wasting time organizing folders. Drag and drop all your unsorted b-roll, interviews, and raw clips right here.
                </p>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="animate-fade-in flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Step 2: Skip Manual Logging</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-[320px]">
                  No more scrubbing through hours of video. We automatically scan every frame to log scenes, tag objects, and transcribe speech for you.
                </p>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="animate-fade-in flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Step 3: Find the Perfect Shot</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-[320px]">
                  Need a <em>"wide shot of a red car"</em> or a specific quote? Just type it. Instantly locate the exact clip you need and get back to editing.
                </p>
              </div>
            )}
          </div>
