  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="flex items-center gap-2 px-6 py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-200 rounded-lg font-medium transition-colors border border-gray-700"
        >
