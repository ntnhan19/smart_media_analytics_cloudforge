      ...
      <div className="flex flex-wrap items-center gap-3 w-full">
        ...
        {isErrorTags ? (
          ...
          <div className="flex items-center gap-2 border-l border-gray-300 dark:border-gray-700 pl-3 ml-1 shrink-0 transition-colors">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-16 h-6 bg-gray-200 dark:bg-[#2D2844] rounded-full animate-pulse transition-colors"></div>
              <div className="w-14 h-6 bg-gray-200 dark:bg-[#2D2844] rounded-full animate-pulse transition-colors"></div>
              <div className="w-20 h-6 bg-gray-200 dark:bg-[#2D2844] rounded-full animate-pulse transition-colors"></div>
            </div>
          </div>
        ) : tags && tags.length > 0 && (
          <div className="flex items-center gap-2 border-l border-gray-300 dark:border-gray-700 pl-3 ml-1 transition-colors flex-1 min-w-0">
            <Tag className={`w-3.5 h-3.5 shrink-0 ${disabled ? 'text-gray-400 dark:text-gray-700' : 'text-gray-600 dark:text-gray-500'} transition-colors`} />
