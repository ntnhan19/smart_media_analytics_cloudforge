...
export default function Settings() {
  ...
  const tabs = [
    ...
    { id: 'ai', label: 'AI & Models', icon: 'lucide:bot' },
  ...
  return (
    <div className="max-w-[1000px] mx-auto h-full flex flex-col relative text-gray-900 dark:text-gray-100 transition-colors pt-4 px-4">
      ...
      <div className="mb-8 shrink-0 relative z-10">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-2 font-medium">Manage system preferences and personalize your experience.</p>
      </div>
              ...
              {activeTab === 'general' && (
                <div className="space-y-8 pb-8">
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Configure basic system settings.</p>
                  </div>
                  ...
                  <div className="bg-white dark:bg-[#16132A]/60 backdrop-blur-xl border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.08)] dark:shadow-sm">
                    <div className="space-y-6">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                        <div className="pr-4">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Auto Save</h3>
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Automatically save your changes.</p>
                        </div>
              ...
              {activeTab === 'ai' && (
                <div className="space-y-8 pb-8">
                  <div className="flex justify-between items-end">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">AI & Models</h2>
                      <p className="text-gray-500 dark:text-gray-400 text-sm">Configure AI providers and API keys.</p>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        <div className="pr-4 sm:w-1/2">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Select AI model provider (Ollama, OpenAI, etc.).</p>
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        <div className="pr-4 sm:w-1/2">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Enter API key if using cloud providers.</p>
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        <div className="pr-4 sm:w-1/2">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Model name for Ollama (e.g., llava:latest).</p>
                        </div>
                        <div className="w-full sm:w-1/2 relative">
              ...
              {activeTab === 'appearance' && (
                <div className="space-y-8 pb-8">
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Customize visual appearance.</p>
                  </div>
                  ...
                  <div className="bg-white dark:bg-[#16132A]/60 backdrop-blur-xl border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.08)] dark:shadow-sm">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
                      <div className="pr-4 max-w-sm">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Choose Light, Dark, or System mode.</p>
                      </div>
              ...
              {activeTab === 'about' && (
                <div className="space-y-8 pb-8">
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Information about the Smart Media Analytics system.</p>
                  </div>
