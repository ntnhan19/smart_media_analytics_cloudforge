          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              {isAuthenticated ? (
                <Link
                  to="/app"
                  className="text-sm font-medium px-5 py-2.5 rounded-xl text-white bg-gradient-to-r from-sma-purple to-sma-blue hover:from-purple-500 hover:to-blue-500 shadow-lg transition-all hover:scale-105 active:scale-95"
                >
                  Dashboard
                </Link>
              ) : (
